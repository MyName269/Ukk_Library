                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <?php
                                                include '../koneksi.php';
                                                $da = mysqli_query($koneksi, "SELECT COUNT(*) total FROM buku");
                                                $ra = mysqli_fetch_assoc($da);
                                                ?>
                                                <a href="fiksi.php">Data Buku</a>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                <?php
                                                include '../koneksi.php';
                                                $ba = mysqli_query($koneksi, "SELECT COUNT(*) total FROM kategoribuku");
                                                $da = mysqli_fetch_assoc($ba);
                                                ?>
                                                <a href="kategori.php" class="text-success">Kategori Buku </a>
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $da['total']; ?>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                <?php
                                                include '../koneksi.php';
                                                $x = mysqli_query($koneksi, "SELECT COUNT(*) total FROM peminjam");
                                                $y = mysqli_fetch_assoc($x);
                                                ?>
                                                <a href="peminjaman.php" class="text-info">Peminjaman</a>
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                ...
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            style="width: <?php echo $y['total']; ?>%"
                                                            aria-valuenow="<?php echo $y['total']; ?>" aria-valuemin="0"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                <?php
                                                include '../koneksi.php';
                                                $b = mysqli_query($koneksi, "SELECT COUNT(*) total FROM user WHERE stat = 'Member'");
                                                $a = mysqli_fetch_assoc($b);
                                                ?>
                                                <a href="user.php" class="text-warning">User</a>
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $a['total']; ?>
                                            </div>
            ...
            <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Done using this application? Click the 'Logout' button to end the login
                            session.
                        </div>
