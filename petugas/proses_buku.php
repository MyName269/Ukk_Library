...
$query = "INSERT INTO buku (judul,penulis,penerbit,kategoriid,tahunterbit,deskripsi,sinopsis,gambar) VALUES('$judul', '$penulis', '$penerbit', '$kategoriid', '$tahunterbit', '$deskripsi', '$sinopsis', '$gambar')";
