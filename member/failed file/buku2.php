...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="koleksisaya.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <div class="row">
                        ...
                        while ($d = mysqli_fetch_assoc($data)) {
                            ...
                            <div class="card shadow mb-3" style="width: 15rem;">
                                <img src="img/<?php echo $d['gambar']; ?>" class="card-img-top" width="300">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?php echo $d['judul']; ?>
                                    </h5>
                                    ...
                                    <a class="btn btn-primary" href="" data-toggle="modal"
                                        data-target="#bukudetailModal<?php echo $d['bukuid']; ?>">Detail</a>
                                    <a class="btn btn-warning" href="" data-toggle="modal"
                                        data-target="#anggotaeditModal<?php echo $d['bukuid']; ?>">Pinjam</a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                ...
                while ($rowA = mysqli_fetch_assoc($result)) {
                    ?>
                    <div class="modal fade" id="anggotaeditModal<?php echo $rowA['bukuid']; ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="p-pinjam.php">
                                            ...
                                            <div class="col">
                                                <div class="input-group mb-3 mt-3">
                                                    ...
                                                    <input type="text" class="form-control" id="bukuid" name="bukuid"
                                                        value="<?php echo $rowA['bukuid']; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="input-group mb-3 mt-3">
                ...
                while ($rowb = mysqli_fetch_assoc($resultb)) {
                    ?>
                    <div class="modal fade" id="bukudetailModal<?php echo $rowb['kategoriid']; ?>" tabindex="-1"
