                    ...
                    <div class="row">
                        <div class="card mt-0">
                                    ...
                                    <div class="input-group mb-3 mt-3">
                                        ...
                                        foreach ($buku as $databuku) {
                                            ...
                                            <input type="text" class="form-control" id="bukuid" name="bukuid"
                                                value="<?php echo $databuku['bukuid']; ?>" readonly>
                                        <?php } ?>
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggalpeminjaman">Pinjam Buku</label>
                                        <input type="date" class="form-control" id="tanggalpeminjaman"
                                            name="tanggalpeminjaman">
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggalpengembalian">Kembali Buku</label>
                            ...
                            <div class="modal-footer">
                                <a href="buku.php" class="btn btn-secondary">Tutup</a>
                                <br>
