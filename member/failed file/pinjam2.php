...
$bukuid = $_GET["bukuid"];
$query = mysqli_query($connection, "SELECT * FROM buku WHERE bukuid = '$bukuid'");
//Menampilkan data siswa yg sedang login
$nisnSiswa = $_SESSION["username"];
$dataSiswa = "SELECT * FROM user WHERE username = $nisnSiswa";
// Peminjaman 
...
<body id="page-top">
        ...
        <form action="" method="POST">
          ...
          <?php foreach ($query as $item) : ?>
           <div class="input-group mb-3">
            ...
            <input type="text" name="bukuid" class="form-control" placeholder="id buku" aria-label="bukuid" aria-describedby="basic-addon1" value="<?= $item["bukuid"]; ?>">
            </div>
          <?php endforeach; ?>
    ...
    <div class="input-group mb-3 mt-3">
            ...
            <input type="date" name="tanggalpengembalian" id="tanggalpengembalian" class="form-control" placeholder="tanggalpengembalian" aria-label="tanggalpengembalian" aria-describedby="basic-addon1">
      </div>
