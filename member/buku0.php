                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <form action="" method="GET" class="mb-3">
                                        <div class="input-group">
                                            <input type="text" name="search" class="form-control" size="35" autofocus
                                ...
                                <br>
                                <!-- Card Body -->
                                <div class="column" style="max-width: 980px;">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-3 g-4">
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $query = "SELECT * FROM buku WHERE judul LIKE '%$search%' OR penulis LIKE '%$search%' OR namakategori LIKE '%$search%' ORDER BY bukuid ASC";
                                        } else {
