        ...
        <div class="card">
            <div class="row m-4">
                <div class="col text-center">
                    <a href="img/<?php echo $result['foto']; ?>"><img src="img/<?php echo $result['foto']; ?>" class="rounded-circle img-thumbnail" width="400"></a>
                </div>
                <div class="col" style="margin-top: 1rem;">
                    <h3>Profile <a href="e-profile.php?userid=<?= $result['userid']; ?>" class="btn btn-sm btn-primary">Edit Profile</a></h3>
                    <hr>
                    <table>
                        <tr>
