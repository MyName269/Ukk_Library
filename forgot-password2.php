...
<head>
    ...
    <title>Perpus Rpl1 - Forgot Password</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-password-image"><img src="assets/img/b1.png">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="f-2.php" method="post" class="user">
                                        <input type="userid" name="userid" value="<?= $_SESSION['userid']; ?>" hidden>
